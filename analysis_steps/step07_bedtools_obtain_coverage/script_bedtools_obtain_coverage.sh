...
cut -f1-3 /home/FCAM/ejaussi/CHIP_STARR_seq/results/macs2/narrow_peak/dna1_peaks.narrowPeak \
				> /home/FCAM/ejaussi/CHIP_STARR_seq/results/coverage/dna1_peaks.bed

# keep the chrom name, start and end columns
cut -f1-3 /home/FCAM/ejaussi/CHIP_STARR_seq/results/macs2/narrow_peak/mRNA1_peaks.narrowPeak \
...
# keep the chrom name, start and end columns
cut -f1-3 /home/FCAM/ejaussi/CHIP_STARR_seq/results/macs2/narrow_peak/dna2_peaks.narrowPeak \
				> /home/FCAM/ejaussi/CHIP_STARR_seq/results/coverage/dna2_peaks.bed

# keep the chrom name, start and end columns
cut -f1-3 /home/FCAM/ejaussi/CHIP_STARR_seq/results/macs2/narrow_peak/mRNA2_peaks.narrowPeak \
...
# keep the chrom name, start and end columns
cut -f1-3 /home/FCAM/ejaussi/CHIP_STARR_seq/results/macs2/narrow_peak/dna3_peaks.narrowPeak \
				> /home/FCAM/ejaussi/CHIP_STARR_seq/results/coverage/dna3_peaks.bed

# keep the chrom name, start and end columns
cut -f1-3 /home/FCAM/ejaussi/CHIP_STARR_seq/results/macs2/narrow_peak/mRNA3_peaks.narrowPeak \
