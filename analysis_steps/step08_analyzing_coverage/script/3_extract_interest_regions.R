...
write.table(interest_regions_all, file="output/3_extract_interest_regions/interest_regions_all.txt", row.names = FALSE, col.names = FALSE, quote = FALSE, sep = "\t")
write.table(interest_regions_sig, file="output/3_extract_interest_regions/interest_regions_sig.txt", row.names = FALSE, col.names = FALSE, quote = FALSE, sep = "\t")
