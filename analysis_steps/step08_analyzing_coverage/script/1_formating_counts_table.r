...
# load raw data
Isoplasmid1_cov <- read.table("C:/Users/etien/Desktop/Stage_Uconn_M1/experiments/CHIP_STARR_seq/analysis_steps/step08_analyzing_coverage/data/raw_coverage//Isoplasmid1_cov.txt", header=FALSE)
Isoplasmid2_cov <- read.table("C:/Users/etien/Desktop/Stage_Uconn_M1/experiments/CHIP_STARR_seq/analysis_steps/step08_analyzing_coverage/data/raw_coverage/Isoplasmid2_cov.txt", header=FALSE)
Isoplasmid3_cov <- read.table("C:/Users/etien/Desktop/Stage_Uconn_M1/experiments/CHIP_STARR_seq/analysis_steps/step08_analyzing_coverage/data/raw_coverage/Isoplasmid3_cov.txt", header=FALSE)
mRNA1_cov <- read.table("C:/Users/etien/Desktop/Stage_Uconn_M1/experiments/CHIP_STARR_seq/analysis_steps/step08_analyzing_coverage/data/raw_coverage/mRNA1_cov.txt", header=FALSE)
mRNA2_cov <- read.table("C:/Users/etien/Desktop/Stage_Uconn_M1/experiments/CHIP_STARR_seq/analysis_steps/step08_analyzing_coverage/data/raw_coverage/mRNA2_cov.txt", header=FALSE)
mRNA3_cov <- read.table("C:/Users/etien/Desktop/Stage_Uconn_M1/experiments/CHIP_STARR_seq/analysis_steps/step08_analyzing_coverage/data/raw_coverage/mRNA3_cov.txt", header=FALSE)
...
save(peak_coverage, file = "output/1_formating_counts_table/peak_coverage.Rdata")
