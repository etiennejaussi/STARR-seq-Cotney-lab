...
write.table(interest_regions_all, file="output/output3_extract_interest_regions/all_interest_regions.txt", row.names = FALSE, col.names = FALSE, quote = FALSE, sep = "\t")
write.table(interest_regions_sig, file="output/output3_extract_interest_regions/sig_interest_regions.txt", row.names = FALSE, col.names = FALSE, quote = FALSE, sep = "\t")
